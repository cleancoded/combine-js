...
<?php endforeach; ?>
                ...
                <p><strong><span style="color:red">Note: </span>You can also add GZIP compression for JS files by adding the lines below to your .htaccess file</strong></p>
                <pre>
# BEGIN JS Compression
&lt;FilesMatch "\.(js)"&gt;
php_value short_open_tag 0
ForceType application/x-httpd-php
php_value auto_prepend_file "<?php echo $this->get_plugin_path(); ?>/includes/gzip-js.php"
&lt;/FilesMatch&gt;
